...
El segundo es el \textbf{equipo técnico o profesional} que trabaja en entornos
con infraestructura ya desplegada o en fase de diseño. Para este perfil, el
problema es organizacional y económico: la elección del proveedor implica estudios
de costes, dependencias de conocimiento del equipo y dificultad para migrar si
las condiciones cambian.

\section{Visión del sistema}

CloudPorter se concibe como una herramienta que aborda el cloud lock-in en todas sus
dimensiones, desde la infraestructura hasta el código, y desde la CLI hasta una
plataforma de gestión completa. A continuación se describe el sistema en su forma
más ambiciosa, sin restricciones de alcance.
...
real, sin comprometer la calidad de lo que se construye.
...
\begin{itemize}
    \item \textbf{RF-11.} El sistema debe analizar las plantillas generadas
    mediante herramientas de análisis estático de IaC antes del despliegue,
    detectando configuraciones inseguras e informando al usuario.
\end{itemize}
