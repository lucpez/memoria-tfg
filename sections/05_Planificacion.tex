...
estructura: objetivo de la iteración, decisiones de diseño, implementación y
resultado. Los cambios menores —incorporación de skills de Claude Code,
actualizaciones del devcontainer o ajustes de configuración de CI— se integran
directamente mediante pull request sin abrir un issue propio, dado que no
requieren un ciclo de diseño formal; se mencionan en el contexto de la iteración
a la que pertenecen.
