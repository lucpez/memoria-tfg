...
Se ha adoptado \textbf{Kanban}~\cite{kanbanAtlassian} como metodología de desarrollo por su adecuación
...
El tablero Kanban se gestiona íntegramente en
\textbf{\href{https://github.com/users/lucpez/projects/2}{GitHub Projects}}, integrado
...
\subsection{Licencia de CloudPorter}

CloudPorter se publica como \textbf{software libre} bajo licencia
\textbf{\href{https://github.com/lucpez/cloudporter/blob/main/LICENSE}{Apache-2.0}}. La
decisión extiende a la propia herramienta el mismo razonamiento que motivó la elección de
OpenTofu: del mismo modo que OpenTofu nació para preservar la libertad que Terraform
abandonó al adoptar una licencia restrictiva, CloudPorter se suma a esa defensa
publicándose en abierto. No es una decisión accesoria: el proyecto se ha construido
íntegramente sobre software libre —OpenTofu, Python, Jinja2 o pytest— y sobre el
conocimiento abierto de la comunidad, de modo que liberar la herramienta devuelve a ese
ecosistema parte de lo recibido. Sería, además, contradictorio combatir el lock-in con una
herramienta a su vez encerrada.

Ambas licencias pertenecen a la familia del software libre y comparten una protección
expresa frente a patentes —una concesión a quien usa el software y la retirada de esa
licencia a quien litigue por ellas—, pero difieren en su filosofía: la \textbf{MPL-2.0}
de OpenTofu es un copyleft débil, que obliga a mantener abiertos los ficheros que se
modifican, mientras que CloudPorter opta por la \textbf{Apache-2.0}, plenamente permisiva.
Esa permisividad —usar, modificar e integrar la herramienta sin restricciones, también en
contextos comerciales— es la que la inclina, al maximizar la adopción.
...
de evaluación y validación. El desarrollo iterativo que refleja la
figura~\ref{fig:gantt} puede contrastarse con el historial de issues, pull requests y
releases del \href{https://github.com/lucpez/cloudporter}{repositorio del proyecto}.
...
\begin{itemize}
    ...
    \item \textbf{Software:} la suscripción a \textbf{Claude Code}, asumida por el autor,
    supuso 21,78~€/mes durante los tres meses de desarrollo (abril–junio de 2026), 65,34~€
    en total. El resto de herramientas son de código abierto o de uso gratuito —Python,
    OpenTofu, GitHub en su plan gratuito, uv, Ruff y pytest—.

    \item \textbf{Suministros:} la parte imputable al proyecto del gasto doméstico de internet
    y electricidad, estimada en torno a 60~€/mes durante los meses de trabajo.

    \item \textbf{Formación:} incluye la formación previa en tecnologías cloud necesaria para
    abordar el proyecto: la certificación \textbf{AWS Cloud Practitioner} (50~€, tras un
    descuento del 50\% sobre su precio de 100~€) y un curso de preparación de la certificación
    \textbf{AWS Solutions Architect Associate} (29,31~€). El resto de la formación fue gratuita:
    documentación oficial, tutoriales en vídeo y la certificación OpenTofu Foundation, de la
    Linux Foundation.
\end{itemize}
