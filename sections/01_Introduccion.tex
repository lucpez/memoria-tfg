...
sino como una \textbf{prueba de concepto}: una implementación deliberadamente acotada
cuyo fin es demostrar que la idea de fondo es viable, construyendo algo básico pero
funcional, en lugar de entregar un producto terminado. Frente a un problema real y de
gran magnitud —el \textbf{cloud lock-in}—, el TFG busca establecer una base sólida y
fundamentada sobre la que seguir avanzando. Los requisitos que se presentan en el
capítulo~\ref{cap:especificacion} describen el sistema en su forma ideal; los objetivos
que se enuncian aquí definen la dirección del trabajo y el alcance que se persigue alcanzar.
...
El apoyo de la IA alcanzó la redacción de los capítulos de la memoria (incluida la traducción
...
\begin{itemize}
    ...
    \hyperlink{skill}{\textit{skills}} reusables propias para profundizar en su especificación, de modo que el
